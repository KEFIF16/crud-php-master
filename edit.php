...
if (!empty($_GET['id'])) {$id = $_REQUEST['id'];}if (null == $id) {
...
<div class="controls">
                            <label class="checkbox">
                                ...
                                if (!empty($row['profile_image_url'])) {
                                    echo '<td>' . '<img src="' . $data['profile_image_url'] . '"alt="' . $dat['profile_image_url'] . '"></td>';
                                } else {
                                    echo '<td>' . '<img src="./uploads/default.webp" alt="' . $data['profile_image_url'] . '"></td>';
                                } ?>
                            </label>
</div>
<p>
