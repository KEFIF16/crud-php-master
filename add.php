...
if ($_SERVER["REQUEST_METHOD"] == "POST" && !empty($_POST)) {
  ...
  $valid = true;
	...
	if (empty($email)) {$emailError = 'Please enter Email Address';
		$valid = false;
  ...
  <body>
    ...
    <div class="container">
      ...
      <form method="post" action="add.php" enctype="multipart/form-data">
        ...
        <div
          class="control-group<?php echo !empty($ageError) ? 'error' : ''; ?>"
        >
        ...
        <div
          class="control-group<?php echo !empty($paysError) ? 'error' : ''; ?>"
        >
          <select name="pays">
...
?>> Integrateur <input type="checkbox" name="metier" value="integrateur"
            <?php if (isset($metier) && $metier == "integrateur") {
	echo "checked";
}
?>> Reseau <input type="checkbox" name="metier" value="reseau"
            <?php if (isset($metier) && $metier == "reseau") {
	echo "checked";
}
?>>
          </div>
        ...
        <div
          class="control-group <?php echo !empty($urlError) ? 'error' : ''; ?>"
        >
